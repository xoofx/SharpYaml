...
| [`YamlConstructorAttribute`](xref:SharpYaml.Serialization.YamlConstructorAttribute) | Constructor | Yes | Yes | Selects which constructor to use for deserialization. |

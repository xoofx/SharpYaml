...
<section class="text-center py-5">
  <div class="container">
    <img src="{{site.basepath}}/img/sharpyaml.svg" alt="SharpYaml" class="img-fluid" style="width: min(100%, 12rem); height: auto;">
    <h1 class="display-4 mt-4">SharpYaml</h1>
    <p class="lead mt-3 mb-4">
      High-performance YAML for .NET: <strong>parser</strong>, <strong>emitter</strong>, and a
      <strong>System.Text.Json-style</strong> object serializer.
    </p>
    ...
    <div class="mt-4 text-start mx-auto" style="max-width: 48rem;">
      ...
      <p class="text-center text-secondary mt-2" style="font-size: 0.85rem;">Available on <a href="https://www.nuget.org/packages/SharpYaml/" class="text-secondary">NuGet</a> -  net8.0, net10.0, netstandard2.0</p>
      <p class="text-center mt-3" style="font-size: 1rem;">
        <img src="https://xoofx.github.io/Tomlyn/img/Tomlyn.png" alt="Tomlyn" style="height: 2rem; width: auto; vertical-align: text-bottom; margin-right: .45rem;">
        Looking for <span style="font-weight: 600;">TOML</span> support? Check out <a href="https://xoofx.github.io/Tomlyn/" class="text-secondary">Tomlyn</a>.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="row row-cols-1 row-cols-lg-2 gx-5 gy-4">
    <div class="col">
      <div class="card h-100">
        ...
        <div class="card-body">
          SharpYaml is intentionally shaped like <code>System.Text.Json</code>: <code>YamlSerializer</code>, <code>YamlSerializerOptions</code>,
    ...
    <div class="col">
      <div class="card h-100">
        ...
        <div class="card-body">
          Use the <strong>syntax/model layer</strong> for lossless parsing, spans, and tooling.
          Use <strong>YamlSerializer</strong> to map YAML into .NET objects (not roundtrip-preserving).
        </div>
      </div>
    </div>
    <div class="col">
      <div class="card h-100">
        ...
        <div class="card-body">
          Reflection fallback can be disabled. For NativeAOT and trimming, use generated metadata via <code>YamlSerializerContext</code> and <code>YamlTypeInfo&lt;T&gt;</code>.
        </div>
      </div>
    </div>
    <div class="col">

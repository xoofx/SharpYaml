...
namespace SharpYaml
{
    internal static class YamlDepthHelper
    {
        ...
        {
            return CreateMaxDepthExceededException(maxDepth, Mark.Empty, Mark.Empty);
        }

        public static YamlException CreateMaxDepthExceededException(int maxDepth, Mark start, Mark end)
        {
            return new YamlException(start, end, $"The maximum nesting depth of {maxDepth} has been exceeded.");
        }
    }
}
